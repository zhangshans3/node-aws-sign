...
// 主要测试套件为http://docs.amazonwebservices.com/AmazonS3/latest/dev/RESTAuthentication.html#ConstructingTheAuthenticationHeader
exports['main'] = function(test) {
	...
	// Example Delete  删除
	// The following is deliberately left here to illustrate that it won't work (see README.md):下面故意留下来说明它行不通。
	opts = {
		method: 'DELETE', 
		host: 'johnsmith.s3.amazonaws.com',
		path: '/photos/puppy.jpg',  
